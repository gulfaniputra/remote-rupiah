...
import { scanExpiredW8BEN, type W8BENScanResult } from "../compliance_cron.ts";
...
Deno.test("scanExpiredW8BEN: future expiry beyond 30d is not flagged", async () => {
  testMocks.clear();
...
Deno.test("scanExpiredW8BEN: expiry within 30 days flags expiringSoon", async () => {
  testMocks.clear();
  // 15 days from now

...
clients. It computes FX conversion spreads, NPPN net income deductions (KLU 62010), and PPh 24
foreign tax credit caps.
...
- Auth uses a dev-only JWT route (`ALLOW_DEV_AUTH`) instead of a prod OAuth flow.

...
var $author$project$Data$TaxProfile$empty = {address: '', kluCode: '', nik: '', npwp: ''};
...
var $author$project$Data$FxEfficiency$FxEfficiencyData = F7(
	function (date, amountCents, amountIdrCents, kmkRate, actualIdrCents, spreadCents, source) {
		return {actualIdrCents: actualIdrCents, amountCents: amountCents, amountIdrCents: amountIdrCents, date: date, kmkRate: kmkRate, source: source, spreadCents: spreadCents};
	});
...
var $cmditch$elm_bigint$BigInt$emptyZero = function (_v0) {
	...
	if (!_v1.b) {
		...
		var d = _v1;
		return $cmditch$elm_bigint$BigInt$Magnitude(d);
	}
};
...
var $cmditch$elm_bigint$BigInt$fromString_ = function (x) {
	return A2(
		$elm$core$Maybe$map,
		function (digitList) {
			return $cmditch$elm_bigint$BigInt$emptyZero(
				$cmditch$elm_bigint$BigInt$Magnitude(
					A2(
						...
						A2(
							...
							$elm$core$List$reverse(digitList)))));
		},
		A2(
			$elm_community$maybe_extra$Maybe$Extra$traverse,
			function (d) {
				var r = $elm$core$Char$toCode(d);
				return ((r >= 48) && (r <= 57)) ? $elm$core$Maybe$Just(r - 48) : $elm$core$Maybe$Nothing;
			},
			x));
};
...
var $cmditch$elm_bigint$BigInt$fromIntString = function (x) {
	var _v0 = $elm$core$String$toList(x);
	if (!_v0.b) {
		return $elm$core$Maybe$Nothing;
	} else {
...
var $author$project$Money$decoder = A2(
	$elm$json$Json$Decode$andThen,
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$elm$core$Maybe$map(
				A2($elm$core$Basics$composeR, $author$project$Money$Money, $elm$json$Json$Decode$succeed)),
			$elm$core$Maybe$withDefault(
				$elm$json$Json$Decode$fail('Invalid authoritative money string')))),
	$elm$json$Json$Decode$string);
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Data$FxEfficiency$decoder = A7(
	$elm$json$Json$Decode$map6,
	F6(
		function (date, amountCents, kmkRate, actualIdrCents, spreadCents, source) {
			var amountIdrCents = function () {
				if (actualIdrCents.$ === 'Just') {
					var actual = actualIdrCents.a;
					return A2($author$project$Money$add, spreadCents, actual);
				} else {
					return spreadCents;
				}
			}();
			return A7($author$project$Data$FxEfficiency$FxEfficiencyData, date, amountCents, amountIdrCents, kmkRate, actualIdrCents, spreadCents, source);
		}),
	A2($elm$json$Json$Decode$field, 'date', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'amount_cents', $author$project$Money$decoder),
	A2(
		$elm$json$Json$Decode$field,
		'kmk_rate',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string)),
	A2(
		$elm$json$Json$Decode$field,
		'actual_idr_cents',
		$elm$json$Json$Decode$nullable($author$project$Money$decoder)),
	A2($elm$json$Json$Decode$field, 'spread_cents', $author$project$Money$decoder),
	A2(
		$elm$json$Json$Decode$field,
		'source',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string)));
var $author$project$Data$FxEfficiency$listDecoder = A2(
	$elm$json$Json$Decode$field,
	'fxData',
...
var $author$project$Api$fetchFxEfficiency = F3(
	function (apiUrl, token, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Data$FxEfficiency$listDecoder),
				headers: _List_fromArray(
					[
						A2($elm$http$Http$header, 'Authorization', 'Bearer ' + token)
					]),
...
var $author$project$Data$TaxProfile$TaxProfile = F4(
	function (npwp, nik, address, kluCode) {
		return {address: address, kluCode: kluCode, nik: nik, npwp: npwp};
	});
var $author$project$Data$TaxProfile$decodeKluCode = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			$elm$json$Json$Decode$string,
			A2($elm$json$Json$Decode$map, $elm$core$String$fromInt, $elm$json$Json$Decode$int)
		]));
var $author$project$Data$TaxProfile$decoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Data$TaxProfile$TaxProfile,
	A2($elm$json$Json$Decode$field, 'npwp', $elm$json$Json$Decode$string),
		...
		return $elm$http$Http$request(
			{
				...
				expect: A2(
					...
					A2(
						$elm$json$Json$Decode$field,
						'data',
						$elm$json$Json$Decode$nullable($author$project$Data$TaxProfile$decoder))),
				headers: _List_fromArray(
					[
						A2($elm$http$Http$header, 'Authorization', 'Bearer ' + token)
					]),
...
var $author$project$Api$MappingRequired = function (a) {
	return {$: 'MappingRequired', a: a};
};
var $author$project$Api$NetworkError = {$: 'NetworkError'};
var $author$project$Api$SessionExpired = {$: 'SessionExpired'};
...
var $author$project$Api$decodeMappingRequired = A2(
	$elm$json$Json$Decode$field,
	'headers',
	$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
var $author$project$Data$Transaction$Transaction = F8(
	function (id, date, currency, amountCents, withholdingCents, actualIdrReceivedCents, kmkRate, is1042sVerified) {
		return {actualIdrReceivedCents: actualIdrReceivedCents, amountCents: amountCents, currency: currency, date: date, id: id, is1042sVerified: is1042sVerified, kmkRate: kmkRate, withholdingCents: withholdingCents};
	});
var $elm$json$Json$Decode$map8 = _Json_map8;
var $author$project$Data$Transaction$decoder = A9(
	$elm$json$Json$Decode$map8,
	$author$project$Data$Transaction$Transaction,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'date', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'currency', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'amount_cents', $author$project$Money$decoder),
	A2($elm$json$Json$Decode$field, 'withholding_cents', $author$project$Money$decoder),
	A2(
		$elm$json$Json$Decode$field,
	...
	A2(
		...
		'kmk_rate',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'is_1042s_verified', $elm$json$Json$Decode$bool));
var $author$project$Api$fetchTransactions = F3(
	function (apiUrl, token, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
								...
								return A2(
									...
									A2(
										...
										A2(
											$elm$json$Json$Decode$field,
											'transactions',
											$elm$json$Json$Decode$list($author$project$Data$Transaction$decoder)),
										body));
							case 'BadStatus_':
								var metadata = response.a;
								var body = response.b;
								return (metadata.statusCode === 428) ? A2(
									$elm$core$Result$andThen,
									function (headers) {
										return $elm$core$Result$Err(
											$author$project$Api$MappingRequired(headers));
									},
									A2(
										$elm$core$Result$mapError,
										function (_v2) {
										...
										A2($elm$json$Json$Decode$decodeString, $author$project$Api$decodeMappingRequired, body))) : ((metadata.statusCode === 401) ? $elm$core$Result$Err($author$project$Api$SessionExpired) : $elm$core$Result$Err($author$project$Api$NetworkError));
							default:
...
var $author$project$Data$Unrealized$Unrealized = F2(
	function (source, unrealizedIdrCents) {
		return {source: source, unrealizedIdrCents: unrealizedIdrCents};
	});
var $author$project$Data$Unrealized$decoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Data$Unrealized$Unrealized,
	A2($elm$json$Json$Decode$field, 'source', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'unrealized_idr_cents', $author$project$Money$decoder));
var $author$project$Data$Unrealized$listDecoder = A2(
	$elm$json$Json$Decode$field,
	'positions',
...
var $author$project$Api$fetchUnrealized = F3(
	function (apiUrl, token, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Data$Unrealized$listDecoder),
				headers: _List_fromArray(
					[
						A2($elm$http$Http$header, 'Authorization', 'Bearer ' + token)
					]),
...
var $author$project$CsvMapper$autoMatchHeaders = function (headers) {
	var canonical = _List_fromArray(
		['date', 'amount', 'currency']);
	var match = F2(
		function (header, acc) {
			var cleaned = $elm$core$String$trim(
				$elm$core$String$toLower(header));
			return A2($elm$core$List$member, cleaned, canonical) ? A3($elm$core$Dict$insert, header, cleaned, acc) : acc;
		});
	return A3($elm$core$List$foldl, match, $elm$core$Dict$empty, headers);
};
var $author$project$CsvMapper$init = F3(
	function (apiUrl, token, headers) {
		return {
			apiUrl: apiUrl,
			mapping: $author$project$CsvMapper$autoMatchHeaders(headers),
			sourceHeaders: headers,
			status: $author$project$CsvMapper$Idle,
			token: token
		};
	});
...
var $author$project$Data$TaxProfile$encoder = function (profile) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'npwp',
				$elm$json$Json$Encode$string(profile.npwp)),
				_Utils_Tuple2(
				'nik',
				$elm$json$Json$Encode$string(profile.nik)),
				_Utils_Tuple2(
				'address',
				$elm$json$Json$Encode$string(profile.address)),
				_Utils_Tuple2(
				'kluCode',
...
var $author$project$Api$saveTaxProfile = F4(
	function (apiUrl, token, profile, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Data$TaxProfile$encoder(profile)),
				expect: A2(
					$elm$http$Http$expectJson,
					toMsg,
					A2($elm$json$Json$Decode$field, 'data', $author$project$Data$TaxProfile$decoder)),
				headers: _List_fromArray(
					[
						A2($elm$http$Http$header, 'Authorization', 'Bearer ' + token)
					]),
...
var $author$project$CsvMapper$Failed = function (a) {
	return {$: 'Failed', a: a};
};
var $author$project$CsvMapper$GotMapping = function (a) {
	return {$: 'GotMapping', a: a};
};
var $author$project$CsvMapper$Loading = {$: 'Loading'};
var $author$project$CsvMapper$MappingSaved = function (a) {
	return {$: 'MappingSaved', a: a};
};
var $author$project$CsvMapper$SaveOk = {$: 'SaveOk'};
...
var $author$project$Api$decodeMapping = A2(
	$elm$json$Json$Decode$andThen,
	function (success) {
		return success ? A2(
			$elm$json$Json$Decode$field,
			...
			$elm$json$Json$Decode$nullable(
				$elm$json$Json$Decode$dict($elm$json$Json$Decode$string))) : $elm$json$Json$Decode$fail('API returned success = false');
	},
	A2($elm$json$Json$Decode$field, 'success', $elm$json$Json$Decode$bool));
var $author$project$Api$fetchCsvMapping = F3(
	function (apiUrl, token, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Api$decodeMapping),
				headers: _List_fromArray(
					[
						A2($elm$http$Http$header, 'Authorization', 'Bearer ' + token)
					]),
...
var $author$project$Api$encodeMapping = function (mapping) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$map,
			function (_v0) {
...
var $author$project$Api$saveCsvMapping = F4(
	function (apiUrl, token, mapping, toMsg) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Api$encodeMapping(mapping)),
...
var $author$project$CsvMapper$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FetchMapping':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: $author$project$CsvMapper$Loading}),
					A3($author$project$Api$fetchCsvMapping, model.apiUrl, model.token, $author$project$CsvMapper$GotMapping));
			case 'GotMapping':
				if (msg.a.$ === 'Ok') {
					if (msg.a.a.$ === 'Just') {
						var m = msg.a.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									mapping: A2($elm$core$Dict$union, m, model.mapping),
									status: $author$project$CsvMapper$Idle
								}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$CsvMapper$Failed('Failed to load mapping')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'SelectTarget':
				var header = msg.a;
				var target = msg.b;
				var updatedMapping = $elm$core$String$isEmpty(target) ? A2($elm$core$Dict$remove, header, model.mapping) : A3($elm$core$Dict$insert, header, target, model.mapping);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{mapping: updatedMapping, status: $author$project$CsvMapper$Idle}),
					$elm$core$Platform$Cmd$none);
			case 'SaveMapping':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: $author$project$CsvMapper$Loading}),
					A4($author$project$Api$saveCsvMapping, model.apiUrl, model.token, model.mapping, $author$project$CsvMapper$MappingSaved));
			default:
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{status: $author$project$CsvMapper$SaveOk}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$CsvMapper$Failed('Failed to save mapping')
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$update = F2(
	function (msg, m) {
		switch (msg.$) {
			case 'GotTransactions':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{appState: $author$project$Main$Ready, txs: txs}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					switch (err.$) {
						case 'SessionExpired':
							return _Utils_Tuple2(
								_Utils_update(
									m,
									{
										appState: $author$project$Main$Failure('Session expired'),
										token: ''
									}),
								$author$project$Main$clearCredentials(_Utils_Tuple0));
						case 'MappingRequired':
							...
							return _Utils_Tuple2(
								_Utils_update(
									m,
									{
										appState: $author$project$Main$MappingRequired(
						...
						default:
							return _Utils_Tuple2(
								_Utils_update(
									m,
									{
										appState: $author$project$Main$Failure('Network error loading transactions')
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
			...
			case 'GotFxEfficiency':
				if (msg.a.$ === 'Ok') {
					var fxLeakage = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{fxLeakage: fxLeakage}),
			...
			case 'UpdateSource':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{source: source}),
					$elm$core$Platform$Cmd$none);
			case 'RequestCsvUpload':
				return _Utils_Tuple2(
					m,
					$author$project$Main$requestCsvFile(_Utils_Tuple0));
			case 'FileSelected':
				var csv = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'CsvMapperMsg':
				var mapperMsg = msg.a;
				var _v2 = m.appState;
				if (_v2.$ === 'MappingRequired') {
					var mapperModel = _v2.a;
					var _v3 = A2($author$project$CsvMapper$update, mapperMsg, mapperModel);
					var nextMapperModel = _v3.a;
					var mapperCmd = _v3.b;
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{
								appState: $author$project$Main$MappingRequired(nextMapperModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$CsvMapperMsg, mapperCmd));
				} else {
					return _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
				}
			case 'GotTaxProfile':
				if (msg.a.$ === 'Ok') {
					var maybeProfile = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{
								taxProfile: A2($elm$core$Maybe$withDefault, $author$project$Data$TaxProfile$empty, maybeProfile)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
				}
			case 'GotComplianceStatus':
				if (msg.a.$ === 'Ok') {
					var status = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'GotSaveTaxProfile':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{taxProfile: savedProfile, uploadStatus: 'Profile saved!'}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{uploadStatus: 'Failed to save profile.'}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Export':
				var year = msg.a;
			...
			case 'GotExportDjp':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{uploadStatus: 'Export completed!'}),
						$author$project$Main$downloadCsv(
							{content: csvContent, filename: 'DJP_Coretax_Export_2026.csv'}));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							m,
...
var $author$project$Main$UpdateKluCode = function (a) {
	return {$: 'UpdateKluCode', a: a};
};
var $author$project$Main$UpdateNik = function (a) {
	return {$: 'UpdateNik', a: a};
};
var $author$project$Main$UpdateNpwp = function (a) {
	return {$: 'UpdateNpwp', a: a};
};
...
var $author$project$CsvMapper$FetchMapping = {$: 'FetchMapping'};
var $author$project$CsvMapper$SaveMapping = {$: 'SaveMapping'};
...
var $author$project$CsvMapper$SelectTarget = F2(
	function (a, b) {
...
var $author$project$CsvMapper$viewRow = F2(
	function (mapping, header) {
		var currentTarget = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Dict$get, header, mapping));
		var hasValidTarget = !$elm$core$String$isEmpty(currentTarget);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('mapper-row')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('mapper-source')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('mapper-arrow')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('→')
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('mapper-target')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$author$project$CsvMapper$SelectTarget(header)),
									$elm$html$Html$Attributes$value(currentTarget)
								]),
							A2(
								$elm$core$List$map,
								function (t) {
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$isEmpty(t) ? '— skip —' : t)
											]));
								},
								$author$project$CsvMapper$canonicalTargets))
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							...
							hasValidTarget ? 'mapper-confidence conf-high' : 'mapper-confidence conf-low')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
...
var $author$project$CsvMapper$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('mapper-card')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mapper-header')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('CSV Field Mapping')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('btn btn-outline'),
								$elm$html$Html$Events$onClick($author$project$CsvMapper$FetchMapping)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Load Saved')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mapper-grid')
					]),
				A2(
					$elm$core$List$map,
					$author$project$CsvMapper$viewRow(model.mapping),
					model.sourceHeaders)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mapper-footer')
					]),
				_List_fromArray(
					[
						function () {
						...
						switch (_v0.$) {
							case 'Failed':
								...
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('text-danger text-sm')
										]),
									_List_fromArray(
										[
							...
							case 'SaveOk':
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('text-green text-sm')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Mapping saved successfully.')
										]));
							default:
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$CsvMapper$SaveMapping)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
...
var $author$project$TaxLogic$maxMoney = F2(
	function (a, b) {
		var _v0 = A2($author$project$Money$compare, a, b);
		if (_v0.$ === 'GT') {
			return a;
		} else {
			return b;
...
var $author$project$TaxLogic$minMoney = F2(
	function (a, b) {
		var _v0 = A2($author$project$Money$compare, a, b);
		if (_v0.$ === 'LT') {
			return a;
...
var $author$project$TaxLogic$sortBrackets = $elm$core$List$sortWith(
	F2(
		function (x, y) {
			return A2($author$project$Money$compare, x.lower, y.lower);
		}));
...
var $author$project$TaxLogic$calculateProgressiveTax = F2(
	function (brackets, income) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (bracket, acc) {
					var limit = function () {
						var _v0 = bracket.upper;
						if (_v0.$ === 'Just') {
							var upper = _v0.a;
							return A2($author$project$TaxLogic$minMoney, income, upper);
						} else {
							return income;
						}
					}();
					return A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$author$project$TaxLogic$maxMoney,
									$author$project$Money$zero,
									A2($author$project$Money$subtract, limit, bracket.lower)),
								bracket.rate),
							10000));
				}),
			$author$project$Money$zero,
...
var $author$project$TaxLogic$defaultBrackets = _List_fromArray(
	[
		{
		lower: $author$project$Money$zero,
		rate: 500,
		upper: $elm$core$Maybe$Just(
			$author$project$Money$fromCentsStr('6000000000'))
	},
		{
		lower: $author$project$Money$fromCentsStr('6000000000'),
		rate: 1500,
		upper: $elm$core$Maybe$Just(
			$author$project$Money$fromCentsStr('25000000000'))
	},
		{
		lower: $author$project$Money$fromCentsStr('25000000000'),
		rate: 2500,
		upper: $elm$core$Maybe$Just(
			$author$project$Money$fromCentsStr('50000000000'))
	},
		{
		lower: $author$project$Money$fromCentsStr('50000000000'),
		rate: 3000,
		upper: $elm$core$Maybe$Just(
			$author$project$Money$fromCentsStr('500000000000'))
	},
		{
		lower: $author$project$Money$fromCentsStr('500000000000'),
		rate: 3500,
...
var $author$project$View$Dashboard$w8BenBadge = function (status) {
	switch (status.$) {
		case 'W8BenValid':
			return A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-green font-mono')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('✅ Valid')
					]));
		case 'W8BenExpired':
			return A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-danger font-mono')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('⚠️ Expired')
					]));
		default:
			return A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-secondary font-mono')
					]),
				_List_fromArray(
					[
...
var $author$project$View$Dashboard$evidenceLockerPanel = function (maybeStatus) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('EVIDENCE LOCKER')
							])),
						function () {
						if (maybeStatus.$ === 'Nothing') {
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Loading compliance status…')
									]));
						} else {
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('text-xs text-secondary font-semibold')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('W-8BEN STATUS')
													])),
												A2(
												$elm$html$Html$div,
												_List_fromArray(
												...
												_List_fromArray(
													[
														$author$project$View$Dashboard$w8BenBadge(status.w8benStatus)
													])),
												function () {
												var _v1 = status.w8benExpiryDate;
												if (_v1.$ === 'Just') {
													var d = _v1.a;
													return A2(
														$elm$html$Html$div,
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('text-xs text-secondary font-mono mt-1')
															]),
														_List_fromArray(
															[
																$elm$html$Html$text('Expiry: ' + d)
															]));
												} else {
													return $elm$html$Html$text('');
												}
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('1042-S DOCUMENTS')
													])),
												$elm$core$List$isEmpty(status.documents) ? A2(
												$elm$html$Html$div,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('text-secondary text-xs mt-1')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('No documents uploaded.')
													])) : A2(
												$elm$html$Html$div,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('table-card mt-1')
													]),
												_List_fromArray(
													[
														A2(
																		...
																		return A2(
																			...
																			_List_fromArray(
																				[
																					...
																					_List_fromArray(
																						[
																							$elm$html$Html$text(doc.documentType)
																						])),
																					A2(
																					$elm$html$Html$td,
																					_List_Nil,
																					_List_fromArray(
																						[
																							$elm$html$Html$text(
																							$elm$core$String$fromInt(doc.taxYear))
																						])),
																					A2(
																					$elm$html$Html$td,
																					_List_Nil,
...
var $author$project$View$Dashboard$isValidNik = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$filter($elm$core$Char$isDigit),
	A2(
		$elm$core$Basics$composeR,
		$elm$core$String$length,
		$elm$core$Basics$eq(16)));
var $author$project$View$Dashboard$isValidNpwp = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$filter($elm$core$Char$isDigit),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$View$Dashboard$summaryCard = F3(
	function (label, value, cls) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('card ' + cls)
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$View$Dashboard$totalFxLeakage = A2(
	...
	F2(
		function (position, acc) {
			return A2($author$project$Money$add, acc, position.spreadCents);
		}),
	$author$project$Money$zero);
var $author$project$View$Dashboard$totalUnrealized = A2(
	$elm$core$List$foldl,
	F2(
		function (position, acc) {
			...
			return nppnStatus.notified ? A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('✅ NPPN Notification filed with DJP')
							]))
...
var $author$project$View$Dashboard$renderReady = F9(
	function (txs, unrealized, fxLeakage, kmkVal, source, uploadStatus, profile, complianceStatus, handlers) {
		var whtIdr = $elm$core$List$isEmpty(txs) ? $author$project$Money$zero : function (m) {
			return A2($author$project$Money$multiply, m, kmkVal);
		}(
			A3(
				$elm$core$List$foldl,
				F2(
					function (tx, acc) {
						return A2($author$project$Money$add, acc, tx.withholdingCents);
					}),
				$author$project$Money$zero,
				txs));
		...
		var finalTaxOwed = A2($author$project$Money$subtract, indo, credit);
		var isOverpayment = A2(
		...
		return A2(
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('WALLET SOURCE')
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										...
										[
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$Events$onInput(handlers.onSourceChange)
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$value('wise')
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('btn btn-primary mt-3'),
											$elm$html$Html$Events$onClick(handlers.onUpload)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Upload CSV')
										])),
									$elm$core$String$isEmpty(uploadStatus) ? $elm$html$Html$text('') : A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('text-secondary mt-2 font-mono text-xs')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(uploadStatus)
										]))
								])),
							A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('TAX PROFILE (DJP)')
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('NPWP')
														])),
													A2(
													$elm$html$Html$input,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$id('tax-npwp'),
															$elm$html$Html$Attributes$class('input'),
															$elm$html$Html$Attributes$value(profile.npwp),
															$elm$html$Html$Events$onInput(handlers.onNpwpChange)
														]),
													_List_Nil),
													((!$elm$core$String$isEmpty(profile.npwp)) && (!$author$project$View$Dashboard$isValidNpwp(profile.npwp))) ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('NPWP must be 15 or 16 digits')
														])) : $elm$html$Html$text('')
												])),
											A2(
											$elm$html$Html$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('NIK')
														])),
													A2(
													$elm$html$Html$input,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$id('tax-nik'),
															$elm$html$Html$Attributes$class('input'),
															$elm$html$Html$Attributes$value(profile.nik),
															$elm$html$Html$Events$onInput(handlers.onNikChange)
														]),
													_List_Nil),
													((!$elm$core$String$isEmpty(profile.nik)) && (!$author$project$View$Dashboard$isValidNik(profile.nik))) ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('validation-error')
													...
													_List_fromArray(
														[
															$elm$html$Html$text('NIK must be 16 digits')
														])) : $elm$html$Html$text('')
												])),
											A2(
											$elm$html$Html$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$id('tax-address'),
															$elm$html$Html$Attributes$class('input'),
															$elm$html$Html$Attributes$value(profile.address),
															$elm$html$Html$Events$onInput(handlers.onAddressChange)
														]),
													_List_Nil)
												])),
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('KLU Code')
														])),
													A2(
													$elm$html$Html$input,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$id('tax-klu'),
															$elm$html$Html$Attributes$class('input'),
															$elm$html$Html$Attributes$value(profile.kluCode),
															$elm$html$Html$Events$onInput(handlers.onKluCodeChange)
														]),
													_List_Nil)
												])),
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('btn btn-primary'),
															$elm$html$Html$Events$onClick(handlers.onSaveProfile)
														]),
													_List_fromArray(
														[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('btn btn-outline'),
															$elm$html$Html$Events$onClick(handlers.onExport)
														]),
													_List_fromArray(
														[
					...
					_List_fromArray(
						[
							A3($author$project$View$Dashboard$summaryCard, 'YTD GROSS', annIdr, 'card-teal'),
							A3($author$project$View$Dashboard$summaryCard, 'FX LEAKAGE', fxLeakageIdr, 'card-default'),
							A3(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('UNREALIZED FX GAIN/LOSS')
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('big-value font-mono text-secondary')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Net Income (NPPN)'),
											A2(
											$elm$html$Html$b,
											_List_Nil,
											_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('PPh 24 Tax Credit'),
											A2(
											$elm$html$Html$b,
											_List_Nil,
											_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$text(taxLiabilityLabel),
											A2(
											$elm$html$Html$b,
											_List_Nil,
											_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('table-card mt-2')
										]),
									_List_fromArray(
										[
											A2(
																...
																A2(
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					tx.is1042sVerified ? A2(
																					$elm$html$Html$span,
																					_List_fromArray(
																						[
																							$elm$html$Html$Attributes$class('text-green flex gap-1 font-mono text-sm')
																						]),
																					_List_fromArray(
																						[
																					...
																					_List_fromArray(
																						[
																							$elm$html$Html$Attributes$class('btn btn-primary font-mono text-xs flex gap-1'),
																							$elm$html$Html$Events$onClick(
																							handlers.onVerify(tx.id))
																						]),
																					_List_fromArray(
																						[
					...
					$author$project$View$Dashboard$evidenceLockerPanel(complianceStatus)
				]));
	});
var $author$project$View$Dashboard$view = F7(
	function (state, kmkVal, source, uploadStatus, profile, complianceStatus, handlers) {
		switch (state.$) {
			case 'Loading':
				return A2(
					$elm$html$Html$div,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Loading transactions…')
										]))
								]))
						]));
			case 'Failure':
				var errorMsg = state.a;
				return A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('CSV mapping required')
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Open the CSV mapper to continue.')
										]))
								]))
						]));
			default:
				var txs = state.a.txs;
				var unrealized = state.a.unrealized;
				var fxLeakage = state.a.fxLeakage;
				return A9($author$project$View$Dashboard$renderReady, txs, unrealized, fxLeakage, kmkVal, source, uploadStatus, profile, complianceStatus, handlers);
		}
	});
var $author$project$Main$view = function (m) {
	...
	switch (_v0.$) {
		...
		case 'MappingRequired':
			var mapperModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$CsvMapperMsg,
				$author$project$CsvMapper$view(mapperModel));
		default:
			var handlers = {
				onAddressChange: $author$project$Main$UpdateAddress,
				...
				onUpload: $author$project$Main$RequestCsvUpload,
				onVerify: $author$project$Main$Verify
			};
			var dashboardState = $author$project$Data$State$Ready(
				{fxLeakage: m.fxLeakage, txs: m.txs, unrealized: m.unrealized});
			return A7(
				...
				A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm$core$Maybe$andThen, $elm$core$String$toInt, m.kmk)),
				m.source,
				m.uploadStatus,
				m.taxProfile,
				m.complianceStatus,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						$author$project$Main$csvSelected($author$project$Main$FileSelected),
						$author$project$Main$uploadCompleted($author$project$Main$FileUploadCompleted)
					]));
		},
